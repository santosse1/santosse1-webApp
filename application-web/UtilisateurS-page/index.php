...
<body>
    <div>
        <form class="Demande-form" action="connetion.php" method="post" align="center">
            <div align="center">
                <div class="bg-U-h3">
                    <h3 class="U-h3">Gestion des Sortante</h3>
                </div>
                <br>
                <div align="right">
                ...
                <div>
                    ...
                    <br>
                    <div align="right" >
                        <a class="link-E" href="http://localhost/application-web/dataE-page/index.php?id=ihsffea&/grnder=Mdaas1/&matricul=465465asdasaF/jdsjK/&user=user5545&dgfsf" target="_blank">liste-E</a>
                        <a class="link-S" href="http://localhost/application-web/dataS-page/index.php?id=aeffshi&/grnder=Meeda8/&matricul=Fasadsa564546/kjsdj/&user=userfsfgd&5455" target="_blank">liste-S</a>
                    </div>
                    <br>
                    <div>
