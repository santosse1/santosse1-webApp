...
<body>
    ...
    <div class="bg-from" align="center" >
        ...
        <div>
            <div>
                <div class="bg-dE-h2">
                    <h2 class="dE-h2"><b><i>La Liste des Sortante</i></b></h2>
                </div>
            </div>
            <br>
            <div>
                    ...
                    <tbody>
                        <?php
                            ...
                            if(isset($_GET['search']))
                            {
                                ...
                                $query = "SELECT * FROM tb_datas WHERE CONCAT(matricule,genderu,nom,prenom,observation,acces) LIKE '%$filtervalues%' ";
